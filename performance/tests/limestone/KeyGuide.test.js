/* global CPUThrottling, page, minFPS, maxCLS, maxINP, stepNumber, maxFCP, maxLCP, passRatio, serverAddr, targetEnv, webVitals, webVitalsURL */
...
describe('KeyGuide', () => {
	...
	it('should have a good CLS, FCP, INP and LCP', async () => {
		...
		for (let step = 0; step < stepNumber; step++) {
			...
			await keyGuidePage.evaluateHandle(() => {
