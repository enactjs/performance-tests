...
describe('ToggleButton', () => {
	...
	it('should have a good CLS, FCP, INP and LCP', async () => {
		...
		for (let step = 0; step < stepNumber; step++) {
			const toggleButtonPage = targetEnv === 'TV' ? page : await newPageMultiple();
			...
			toggleButtonPage.on("console", (msg) => {
			...
			await toggleButtonPage.evaluateHandle(() => {
			...
			if (targetEnv === 'PC') await toggleButtonPage.close();
		}
