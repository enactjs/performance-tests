...
class coreWebVitals {
	...
	static async attachCwvLib (page) {
		await page.evaluateHandle(() => {
			// Including the coreWebVitals library
			window.webVitals = (function (e) {
				"use strict"; var n, t, r, i, o, a = -1, c = function (e) {
						...
						let e = u(); return e && e.activationStart || 0;
					}, f = function (e, n) {
						let t = u(), r = "navigate"; a >= 0 ? r = "back-forward-cache" : t && (document.prerendering || s() > 0 ? r = "prerender" : document.wasDiscarded ? r = "restore" : t.type && (r = t.type.replace(/_/g, "-"))); return {name: e, value: void 0 === n ? -1 : n, rating: "good", delta: 0, entries: [], id: "v3-".concat(Date.now(), "-").concat(Math.floor(8999999999999 * Math.random()) + 1e12), navigationType: r};
					}, d = function (e, n, t) {
						try {
						...
						let n = !1; return function (t) {
							n || (e(t), n = !0);
						};
					}, h = -1, g = function () {
						return  document.visibilityState !== "hidden" || document.prerendering ? 1 / 0 : 0;
					}, T = function (e) {
						document.visibilityState === "hidden" && h > -1 && (h = e.type === "visibilitychange" ? e.timeStamp : 0, E());
					}, y = function () {
						...
						n = n || {}, L(function () {
							var t, r = C(), i = f("FCP"), o = d("paint", function (e) {
								e.forEach(function (e) {
									e.name === "first-contentful-paint" && (o.disconnect(), e.startTime < r.firstHiddenTime && (i.value = Math.max(e.startTime - s(), 0), i.entries.push(e), t(!0)));
								});
					...
					}, w = [0.1, 0.25], P = function (e, n) {
						n = n || {}, S(m(function () {
							let t, r = f("CLS", 0), i = 0, o = [], a = function (e) {
									e.forEach(function (e) {
										if (!e.hadRecentInput) {
											let n = o[0], t = o[o.length - 1]; i && e.startTime - t.startTime < 1e3 && e.startTime - n.startTime < 5e3 ? (i += e.value, o.push(e)) : (i = e.value, o = [e]);
										}
									}), i > r.value && (r.value = i, r.entries = o, t());
								}, u = d("layout-shift", a); u && (t = l(e, r, w, n.reportAllChanges), p(function () {
								a(u.takeRecords()), t(!0);
							}), c(function () {
					...
					}, I = {passive: !0, capture: !0}, F = new Date(), A = function (e, i) {
						n || (n = i, t = e, r = new Date(), k(removeEventListener), M());
					}, M = function () {
						if (t >= 0 && t < r - F) {
							let e = {entryType: "first-input", name: n.type, target: n.target, cancelable: n.cancelable, startTime: n.timeStamp, processingStart: n.timeStamp + t}; i.forEach(function (n) {
								n(e);
							}), i = [];
						}
					}, D = function (e) {
						if (e.cancelable) {
							let n = (e.timeStamp > 1e12 ? new Date() : performance.now()) - e.timeStamp; e.type == "pointerdown" ? (function (e, n) {
								var t = function () {
										A(e, n), i();
									}, r = function () {
										i();
						...
						r = r || {}, L(function () {
							let o, a = C(), u = f("FID"), s = function (e) {
									e.startTime < a.firstHiddenTime && (u.value = e.processingStart - e.startTime, u.entries.push(e), o(!0));
								}, v = function (e) {
									e.forEach(s);
								}, h = d("first-input", v); o = l(e, u, B, r.reportAllChanges), h && p(m(function () {
								v(h.takeRecords()), h.disconnect();
							})), h && c(function () {
								let a; u = f("FID"), o = l(e, u, B, r.reportAllChanges), i = [], t = -1, n = null, k(addEventListener), a = s, i.push(a), M();
							});
						});
						...
						let n = G[G.length - 1], t = J[e.interactionId]; if (t || G.length < 10 || e.duration > n.latency) {
							if (t) {
								t.entries.push(e), t.latency = Math.max(t.latency, e.duration);
							} else {
								let r = {id: e.interactionId, latency: e.duration, entries: [e]}; J[r.id] = r, G.push(r);
							}G.sort(function (e, n) {
						...
						n = n || {}, L(function () {
							let t; j(); let r, i = f("INP"), o = function (e) {
									e.forEach(function (e) {
										(e.interactionId && K(e), e.entryType === "first-input") && (!G.some(function (n) {
											return n.entries.some(function (n) {
												return e.duration === n.duration && e.startTime === n.startTime;
											});
										}) && K(e));
									}); let n, t = (n = Math.min(G.length - 1, Math.floor(z() / 50)), G[n]); t && t.latency !== i.value && (i.value = t.latency, i.entries = t.entries, r());
								}, a = d("event", o, {durationThreshold: (t = n.durationThreshold) !== null && void 0 !== t ? t : 40}); r = l(e, i, q, n.reportAllChanges), a && ("interactionId" in PerformanceEventTiming.prototype && a.observe({type: "first-input", buffered: !0}), p(function () {
						...
						n = n || {}, L(function () {
							let t, r = C(), i = f("LCP"), o = function (e) {
									let n = e[e.length - 1]; n && n.startTime < r.firstHiddenTime && (i.value = Math.max(n.startTime - s(), 0), i.entries = [n], t());
								}, a = d("largest-contentful-paint", o); if (a) {
								t = l(e, i, U, n.reportAllChanges); let u = m(function () {
						...
						n = n || {}; let t = f("TTFB"), r = l(e, t, Y, n.reportAllChanges); Z(function () {
							let i = u(); if (i) {
								let o = i.responseStart; if (o <= 0 || o > performance.now()) {
									return;
					...
					}; return e.CLSThresholds = w, e.FCPThresholds = b, e.FIDThresholds = B, e.INPThresholds = q, e.LCPThresholds = U, e.TTFBThresholds = Y, e.getCLS = P, e.getFCP = S, e.getFID = x, e.getINP = Q, e.getLCP = X, e.getTTFB = $, e.onCLS = P, e.onFCP = S, e.onFID = x, e.onINP = Q, e.onLCP = X, e.onTTFB = $, Object.defineProperty(e, "__esModule", {value: !0}), e;
			})({});
		});
	}
