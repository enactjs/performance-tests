...
describe('PopupMenu', () => {
	...
	it('should have a good CLS, FCP, INP and LCP', async () => {
		...
		for (let step = 0; step < stepNumber; step++) {
			...
			const stepVitals = collectWebVitals(popupMenuPage);

			await popupMenuPage.evaluateHandle(() => {
